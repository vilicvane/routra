...
export type SchemaStateInput_<TSchema> =
  TSchema extends SchemaStatePart<infer TState>
...
export type SchemaState_<TSchema> =
  TSchema extends SchemaStatePart<infer TState>
    ? TState extends (
...
type SchemaStatePart<TState extends object> = {
  $state: TState;
};
